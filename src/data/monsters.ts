...
const MONSTERS_RAW: Record<string, Omit<Monster, 'id'>> = {
  ...
  magicFrog: {
    ...
    chanceGet: { healOverhang: 0.1, blueHat: 0.1 },
    chaseChance: 0.4,
  },
  darkBat: {
    maxHp: 100,
  ...
  witch_4: {
    ...
    chanceGet: { lightHat: 0.05, starStaff: 0.05 },
    chaseChance: 0.2,
  },
  group: {
    maxHp: 150,
    ...
    chanceGet: { evilSword: 0.1, misteryBox: 0.1 },
    chaseChance: 0.2,
  },
  mithril: {
    maxHp: 150,
  ...
  magicSkeleton: {
    ...
    chanceGet: { poizonStaff: 0.1, iceStaff: 0.1, fireStaff: 0.1 },
    chaseChance: 0.6,
  },
  warriorSkeleton: {
    maxHp: 200,
    ...
    range: 5,
    reward: { crystal: 3, bone: 4, soul: 1, gold: 8 },
    chanceGet: { blockAxe: 0.03, darkGoldAxe: 0.03, lightHammer: 0.03, teethAxe: 0.03 },
    chaseChance: 0.6,
  },
  waterLord: {
    maxHp: 600,
  ...
  queenSkeleton: {
    ...
    range: 25,
    reward: { crystal: 8, bone: 4, soul: 1, gold: 12 },
    chanceGet: { skStaff: 0.1, charmRing: 0.1 },
    chaseChance: 0.6,
  },
  blackMist: {
    maxHp: 400,
  ...
  whiteMist: {
    ...
    range: 100,
    reward: { gem: 10 },
    chanceGet: { blessingOverhang: 0.2 },
    chaseChance: 0,
  },
  fireDragon: {
    maxHp: 1200,
  ...
  vampire: {
    ...
    range: 1,
    reward: { gold: 20 },
    chanceGet: { curseSword: 0.02, countJacket: 0.1 },
    chaseChance: 0.6,
  },
  vampireGirl: {
    maxHp: 2500,
  ...
  degeneratePaladin: {
    ...
    range: 1,
    reward: { gold: 300 },
    chanceGet: { shelter: 0.05, blessingHammer: 0.05 },
    chaseChance: 0.5,
  },
  kiteHawk: {
    maxHp: 10000,
  ...
  hellGladiator: {
    ...
    range: 3,
    reward: { gold: 400 },
    chanceGet: { breakSword: 0.05, shootShoe: 0.05 },
    chaseChance: 0.5,
  },
  fuseGiant: {
    maxHp: 10000,
